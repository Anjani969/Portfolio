...
Creating responsive and modern layouts using CSS
...
Problem solving using logical and optimized approaches

Experience working with Java for application development
...
Task organization for daily productivity

Technologies Used

The portfolio and projects are developed using the following technologies:
...
Java for programming and application logic

SQL for database concepts and data handling
